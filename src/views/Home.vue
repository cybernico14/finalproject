  ...
  <div class="wrapper">
    ...
    <div class="taskItem">
      <TaskItem
        ...
        :key="task.id"
        :task="task"
        @addTaskChild="getTasks"
        @markAsCompleted="taskCompleted"
...
const taskCompleted = async (task) => {
  ...
  //const toggle = !task.is_complete;
  //console.log(taskId, toggle);
  //await taskStore.markAsCompleted(taskId, toggle);
  taskStore.fetchTasks();
};

onMounted(() => taskStore.fetchTasks());
onUpdated(() => taskStore.fetchTasks());
